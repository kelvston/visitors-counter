            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-sm text-center">
                        ...
                        <tbody>
                        <?php $__currentLoopData = ['today'=>'Today','yesterday' => 'Yesterday', 'weekly' => 'Last Week', 'monthly' => 'This Month', 'lastMonth' => 'Last Month', 'threeMonths' => 'Last Three Months', 'total' => 'TOTAL VISITS']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($label); ?></td>
                                <td><?php echo e($summary[$period]['Male']); ?></td>
                                <td><?php echo e($summary[$period]['Female']); ?></td>
                                <td><?php echo e($summary[$period]['Other']); ?></td>
                                <td><?php echo e($summary[$period]['totalVisits']); ?></td>
                            </tr>
        ...
        <div class="col-md-3 mb-1">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    <form id="incrementForm" action="<?php echo e(route('counter.increment')); ?>" method="POST" class="mb-3">
                        <?php echo csrf_field(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const pieChartData = {
            ...
            datasets: [{
                ...
                data: [<?php echo e($summary['today']['Male']); ?>, <?php echo e($summary['today']['Female']); ?>, <?php echo e($summary['today']['Other']); ?>],
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\visitor-counter\resources\views/counter.blade.php ENDPATH**/ ?>